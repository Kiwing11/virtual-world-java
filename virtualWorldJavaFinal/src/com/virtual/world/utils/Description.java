...
import com.virtual.world.Organism;

public class Description {
    public static String stateOfGame = "";
    ...
    public static void describeMove(Organism o){
    ...
    public static void describeBirth(Organism o){
        String text = "Narodziny nowego organizmu: " + o.getName()+" ["+ o.getPos().x+","+ o.getPos().y+"]\n";
        stateOfGame += text;
    }

    public static void describeSpread(Organism o){
        String text = o.getName() + " rosnie na polu "+" ["+ o.getPos().x+","+ o.getPos().y+"]\n";
        stateOfGame += text;
    }

    public static void describeNextTurn(int turn){
        String text = "=======\n" + "TURA " + turn + "\n" + "=======\n";
        stateOfGame += text;
    }
